            ...
            for dados_dict in dados_list:
                ...
                if dados_dict['id_promocao'] is None:
                    ...
                    promocao_list = self.select('promocao',
                        [ 'id_promocao' ],
                        ["id_promocao={}".format(dados_dict['id_promocao']), "id_empresa={}".format(dados_dict['id_empresa'])]
                    )
                ...
                if promocao_list:   
                    ...
                    self.update('promocao',
                        [
                            ...
                            "id_produto={}".format(dados_dict['id_produto']), "id_grupo_empresa={}".format(dados_dict['id_grupo_empresa']), "id_empresa={}".format(dados_dict['id_empresa']),
                    ...
                    self.insert('promocao',
                        [
                            'titulo', 'tipo', 'desconto_total', 'desconto_por_unidade', 'id_produto', 'id_grupo_empresa', 'id_empresa', 'data_ini', 'data_fim',
                        ...
                        [
                            ...
                            "{}".format(dados_dict['id_empresa']), "'{}'".format(dados_dict['data_ini']), "'{}'".format(dados_dict['data_fim']),
